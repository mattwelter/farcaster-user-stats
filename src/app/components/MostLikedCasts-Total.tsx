    ...
    <div className="casts">
      {casts.length !== 0 ? casts.map((cast: any) => (
        <section className="cast">
          ...
          <a className="likes">{ cast.total_likes } <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a className="link-to-warpcast">View on Warpcast</a>
        </section>
        )) : <section className="cast">
            <a>Oops!</a>
