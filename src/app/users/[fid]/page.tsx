...
export default async function Page({ params }: {
    ...
    return (
        <main className={style['top-bottom-padding']}>
            {/* <p>You guys are breaking my site lol. I need time to fix this, please <a className={'white'} href="https://warpcast.com/fun">follow @fun on Farcaster</a> for updates.</p> */}
